    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-100">
      <header className="border-b border-white/5 px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-green-400">ReUsa<span className="text-gray-600">.ve</span></span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          {stats.map(s => (
            <div key={s.label} className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-5">
              ...
              <p className="text-2xl font-black text-gray-100">{s.value.toLocaleString()}</p>
